...
-> Export as: Printable PDF / Editable Word Document / Auto-built Google Form -> Optional answer key generation
...
Redis-based caching + scalable rate limiting
Multi-model failover (Gemini → Groq → Claude)
Difficulty level & Bloom taxonomy classification
Better Google Form quiz automation
